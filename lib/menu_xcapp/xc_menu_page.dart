...
class _XcMenuPageState extends State<XcMenuPage> with SingleTickerProviderStateMixin {
  ...
  /// Kirim pengaturan penting ke native (selected packages, postUrl, enabled)
  ...
  Future<void> _startListening() async {
    ...
    // optional: show flutter persistent notif too for while app alive
